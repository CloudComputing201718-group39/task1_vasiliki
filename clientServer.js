...
router.route('/exercise1_task1')
    .get(function(req, res)
    {
        ...
        exec('users | wc -w', (e, numOfUsers, stderr)=> {
            if (e instanceof Error) {
                console.error(e);
                throw e;
            }

              console.log('The number of logged in Users is: ', numOfUsers);
              exercise_1_Message.numberUsers = numOfUsers;

        });

        exec('users', (e, usernames, stderr)=> {
            if (e instanceof Error) {
                console.error(e);
                throw e;
            }
            ...
            exercise_1_Message.userNames = usernames;
